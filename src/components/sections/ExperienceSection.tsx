...
export function ExperienceSection() {
  ...
  return (
    <div id="experience" className="bg-[#faf9f7]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_480px] items-center px-6 md:px-16 pt-14 md:pt-20 pb-8 md:pb-10 gap-10 md:gap-20">
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[480px_1fr] items-center px-6 md:px-16 pt-8 md:pt-10 pb-14 md:pb-20 gap-10 md:gap-20">
