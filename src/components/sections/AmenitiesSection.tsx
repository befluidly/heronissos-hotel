...
export function AmenitiesSection() {
  ...
  return (
    <section id="amenities" className="px-10 py-[72px] border-t border-black/10">
      ...
      <div className="grid grid-cols-4 gap-8">
        {items.map((item, i) => (
          <div key={i} className="pt-7 border-t border-black/10">
            <span className="block text-xl text-[#aaa] mb-4">{ICONS[i]}</span>
