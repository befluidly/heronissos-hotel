...
export function TrustBar({ hotelInfo }: Props) {
  const bookingScore = hotelInfo?.bookingScore ?? 9.4;
  const tripadvisorScore = hotelInfo?.tripadvisorScore ?? 4.1;
    ...
    <div className="bg-[#1b1b1b] border-t border-white/[0.06] px-6 md:px-10 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 md:gap-10">
        ...
        <div className="flex items-center gap-3">
          <div className="text-left">
            <div className="flex items-baseline gap-1.5">
              <span className="font-display text-[22px] font-light text-white">{bookingScore}</span>
        ...
        <div className="flex items-center gap-3">
          <div className="text-left">
            <div className="flex items-baseline gap-1.5">
              <span className="font-display text-[22px] font-light text-white">{tripadvisorScore}</span>
